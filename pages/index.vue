<template>
  <img alt="Снимка на Кърти чисти и извозва" width="1905" height="700" src="/background.jpg" class="absolute inset-0 h-200 w-full object-cover">
  <div class="relative mx-auto max-w-5xl flex px-4 py-44 text-4xl font-bold">
    <div class="relative z-10 bg-black/60 py-4 sm:py-24">
